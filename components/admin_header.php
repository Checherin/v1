<header class="header">
    <div class="header_container">
        <h1 class="logo"><a href="../public/index.php">DEKKO</a></h1>
        <nav class="navigation">
            <ul class="navigation_list">
                <li class="navigation_item"><a href="../public/index.php" class="navigation_link">Главная</a></li>
                ...
                <li class="navigation_item"><a href="dashboard.php" class="navigation_link">Админка</a></li>
